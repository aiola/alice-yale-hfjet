void runEMCalJetAnalysisOldJetPrep_AP(
...
{
  gROOT->LoadMacro("$ALICE_PHYSICS/PWGJE/EMCALJetTasks/macros/runEMCalJetAnalysisOldJetPrep.C");
  runEMCalJetAnalysisOldJetPrep(cDataType, cLocalFiles, iNumFiles, iNumEvents, cRunPeriod, cTaskName);
}
