...
def PlotBFeedDown():
    ...
    cname = "BFeedDown_JetZSpectrum_JetPt_15_30_InternalPlot"
    ...
    canvas2 = ROOT.TCanvas("BFeedDown_JetZSpectrum_JetPt_15_30_Paper", "BFeedDown_JetZSpectrum_JetPt_15_30_Paper")
    ...
    paveALICE.AddText("with D^{0} #rightarrow K^{-}#pi^{+} and charge conj., #it{p}_{T,D} > 6 GeV/#it{c}")
...
def main():
    ...
    canvas1.SaveAs("{0}/BFeedDown_JetZSpectrum_JetPt_15_30_InternalPlot.pdf".format(input_path))
    canvas2.SaveAs("{0}/BFeedDown_JetZSpectrum_JetPt_15_30_Paper.pdf".format(input_path))
    canvas2.SaveAs("{0}/BFeedDown_JetZSpectrum_JetPt_15_30_Paper.C".format(input_path))
