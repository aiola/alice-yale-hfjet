...
def FD_FoldUnfold_Comparison(histograms):
    ...
    baseline.SetTitle("Generator Level")
    detector.SetTitle("Detector Level (b #rightarrow D^{0} resp. matrix)")
    unfolded.SetTitle("Unfolded (c #rightarrow D^{0} resp. matrix)")
    unfolded_b.SetTitle("Unfolded (b #rightarrow D^{0} resp. matrix)")
