...
def PlotSBInvMass(pad, dmeson, ptmin, ptmax, sbList, dptbinList, refl, plotleg1=False, plotleg2=False):
    pad.SetTicks(1, 1)
...
def SideBandPlot():
    ...
    canvas.Divide(3, 2)
    PlotSBInvMass(canvas.cd(1), loader.fDMeson, 4, 5, sbList, dptbinList, "_DoubleGaus", True, False)
    PlotSBInvMass(canvas.cd(2), loader.fDMeson, 6, 7, sbList, dptbinList, "_DoubleGaus", False, True)
    PlotSBInvMass(canvas.cd(3), loader.fDMeson, 10, 12, sbList, dptbinList, "_DoubleGaus", False, False)
