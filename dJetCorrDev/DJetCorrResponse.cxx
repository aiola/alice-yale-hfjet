...
Bool_t DJetCorrResponse::ProjectResponseJetPtZ(DJetCorrAnalysisParams* params, Int_t dptBin)
{
  ...
  measured->GetXaxis()->SetTitle("#it{p}_{T,jet}^{ch,det} (GeV/#it{c})");
  ...
  truthReco->GetXaxis()->SetTitle("#it{p}_{T,jet}^{ch,part} (GeV/#it{c})");
  ...
  truth->GetXaxis()->SetTitle("#it{p}_{T,jet}^{ch,part} (GeV/#it{c})");
  ...
  truthRecoAll->GetXaxis()->SetTitle("#it{p}_{T,jet}^{ch,part} (GeV/#it{c})");
  ...
  misses->GetXaxis()->SetTitle("#it{p}_{T,jet}^{ch,part} (GeV/#it{c})");
  ...
  kinEff->GetXaxis()->SetTitle("#it{p}_{T,jet}^{ch,part} (GeV/#it{c})");
  ...
  kinMisses->GetXaxis()->SetTitle("#it{p}_{T,jet}^{ch,part} (GeV/#it{c})");
...
Bool_t DJetCorrResponse::ProjectResponseJetPt(DJetCorrAnalysisParams* params, Int_t zBin, Int_t dptBin)
{
  ...
  respFull->SetName(hname);
  respFull->SetTitle(htitle);
  respFull->GetXaxis()->SetTitle("#it{p}_{T,jet}^{ch,det} (GeV/#it{c})");
  respFull->GetYaxis()->SetTitle("#it{p}_{T,jet}^{ch,part} (GeV/#it{c})");
  fOutputList->Add(respFull);
  ...
  if (fEfficiencyMode.Contains("TH1")) {
    ...
    eff->SetTitle(htitle);
    eff->GetXaxis()->SetTitle("#it{p}_{T,jet}^{ch,part} (GeV/#it{c})");
    eff->GetYaxis()->SetTitle("Jet Reconstruction Efficiency");
...
Bool_t DJetCorrResponse::ProjectResponseZ(DJetCorrAnalysisParams* params, Int_t jetPtBin, Int_t dptBin)
{
  ...
  htitle = Form("Response matrix for #it{z}_{||}: %.1f < #it{p}_{T,jet}^{ch,part} < %.1f GeV/#it{c}", minJetPt, maxJetPt);
...
Bool_t DJetCorrResponse::PlotResponseJetPtVsDPt(DJetCorrAnalysisParams* params)
{
  ...
  canvasEff = SetUpCanvas(cEffName,
                          "#it{p}_{T,jet}^{ch}^{ch,part} (GeV/#it{c})", params->GetMinJetPt(), params->GetMaxJetPt(), kFALSE,
                          "Efficiency", 0., 1e-6, kFALSE);
...
Bool_t DJetCorrResponse::PlotEfficiencyJetPtZ(TCanvas*& canvasEff, DJetCorrAnalysisParams* params, Int_t dptBin)
{
  ...
  if (canvasEff) {
    ...
    if (!canvasEff) {
      Double_t extraSpace = (params->GetMaxZ() - params->GetMinZ()) * 0.3;
      canvasEff = SetUpCanvas(hname,
                              eff->GetXaxis()->GetTitle(), params->GetMinJetPt(), params->GetMaxJetPt(), kFALSE,
                              eff->GetYaxis()->GetTitle(), params->GetMinZ(), params->GetMaxZ() + extraSpace, kFALSE,
                              700, 600, 1, 1,
                              0.10, 0.10, 0.10, 0.07);
      doPlotting = kTRUE;
    }
...
Bool_t DJetCorrResponse::PlotResponseMatrixJetPt(TCanvas*& canvasResp, DJetCorrAnalysisParams* params, Int_t zBin, Int_t dptBin)
{
  ...
  if (canvasResp) {
    ...
    if (!canvasResp) {
      Double_t extraSpace = (params->GetMaxJetPt() - params->GetMinJetPt()) * 0.3;
      canvasResp = SetUpCanvas(resp->GetName(),
                               resp->GetXaxis()->GetTitle(), params->GetMinJetPt(), params->GetMaxJetPt(), kFALSE,
                               resp->GetYaxis()->GetTitle(), params->GetMinJetPt(), params->GetMaxJetPt() + extraSpace, kFALSE,
                               700, 600, 1, 1,
                               0.10, 0.12, 0.10, 0.07);
      doPlotting = kTRUE;
    }
...
Bool_t DJetCorrResponse::PlotEfficiencyJetPt(TCanvas*& canvasEff, DJetCorrAnalysisParams* params, Int_t zBin, Int_t dptBin)
{
  ...
  if (doPlotting) {
    ...
    FitObjectInPad(effCopy, canvasEff, "P E Z", kTRUE);
  ...
  if (canvasResp) {
    ...
    if (!canvasResp) {
      ...
      canvasResp = SetUpCanvas(resp->GetName(),
                               ...
                               resp->GetYaxis()->GetTitle(), params->GetMinZ(), params->GetMaxZ() + extraSpace, kFALSE,
                               700, 600, 1, 1,
                               0.10, 0.12, 0.10, 0.07);
      doPlotting = kTRUE;
    }
...
Bool_t DJetCorrResponse::PlotEfficiencyZ(TCanvas*& canvasEff, DJetCorrAnalysisParams* params, Int_t jetPtBin, Int_t dptBin, Int_t jetPtBinStep, Int_t dptBinStep)
{
  ...
  if (doPlotting) {
    ...
    if (jetPtBin >= -1 && dptBin >= -1) {
      ...
      hcopyTitle = Form("%.0f < #it{p}_{T,jet}^{ch,part} < %.0f GeV/#it{c}",
                        minJetPt, maxJetPt);
    }
    else if (dptBin >= -1) {
      if (dptBin == -1) {
    ...
    FitObjectInPad(effCopy, canvasEff, "P E Z", kTRUE, 1.9);
...
Bool_t DJetCorrResponse::PlotResponseMatrixDPt(TCanvas*& canvasResp, DJetCorrAnalysisParams* params)
{
  ...
  if (canvasResp) {
    ...
    canvasResp = GetCanvas(resp->GetName());
    if (!canvasResp) {
      Double_t extraSpace = (params->GetMaxDPt() - params->GetMinDPt()) * 0.3;
      canvasResp = SetUpCanvas(resp->GetName(),
                               resp->GetXaxis()->GetTitle(), params->GetMinDPt(), params->GetMaxDPt(), kFALSE,
                               resp->GetYaxis()->GetTitle(), params->GetMinDPt(), params->GetMaxDPt() + extraSpace, kFALSE,
                               700, 600, 1, 1,
                               0.10, 0.12, 0.10, 0.07);
      doPlotting = kTRUE;
    }
...
Bool_t DJetCorrResponse::PlotEfficiencyDPt(TCanvas*& canvasEff, DJetCorrAnalysisParams* params)
{
  ...
  if (doPlotting) {
    canvasEff->cd();
    FitObjectInPad(eff, canvasEff, "P E Z", kTRUE);
  }
