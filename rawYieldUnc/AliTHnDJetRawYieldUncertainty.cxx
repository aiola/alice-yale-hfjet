...
#include "AliTHnDJetRawYieldUncertainty.h"

/// \cond CLASSIMP
ClassImp(AliTHnDJetRawYieldUncertainty);
/// \endcond

/**
 * Default constructor.
 */
AliTHnDJetRawYieldUncertainty::AliTHnDJetRawYieldUncertainty():
 ...
 */
AliTHnDJetRawYieldUncertainty::AliTHnDJetRawYieldUncertainty(const AliTHnDJetRawYieldUncertainty &source):
 ...
 */
Bool_t AliTHnDJetRawYieldUncertainty::ExtractInputMassPlotEffScale()
{
 ...
 */
Bool_t AliTHnDJetRawYieldUncertainty::ExtractInputMassPlotSideband()
{
  std::cout << "Extracting input mass plot: " << fpTmin << " to " << fpTmax << std::endl;
