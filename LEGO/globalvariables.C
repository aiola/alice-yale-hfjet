...
// definition for Rudiger
UInt_t kPhysSelRH = AliVEvent::kMB + AliVEvent::kSemiCentral +
AliVEvent::kCentral;
...
TString kEmcalJets3GeVR02NameTEST(Form("Jet_AKTFullR020_%s_pT3000_%s_ET3000_pt_scheme",kTracksNameTEST.Data(),kCorrClusName.Data()));
TString kEmcalJets3GeVR02NameTEST2(Form("Jet_AKTFullR020_%s_pT3000_%s_ET3000_pt_scheme",kTracksNameTEST.Data(),kClusName.Data()));
TString kEmcalJets5GeVR02NameTEST2(Form("Jet_AKTFullR020_%s_pT5000_%s_ET5000_pt_scheme",kTracksNameTEST.Data(),kClusName.Data()));
TString kEmcalJets3GeVR01NameTEST(Form("Jet_AKTFullR010_%s_pT3000_%s_ET3000_pt_scheme",kTracksNameTEST.Data(),kCorrClusName.Data()));
